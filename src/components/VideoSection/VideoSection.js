...
export default function VideoSection() {
    ...
    // initializes current video data to be video-info/object with matching id from video list
    ...
    return (
        <section className="videos">
            ...
            <div className="videos__layout">
                <MainVideo />
                <NextVideos changeMainVideoData={changeMainVideoData} currentVideoId={currentVideoId}/>
            </div>
        </section>
    )
}